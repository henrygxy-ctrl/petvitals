---
title: "Can Cats Eat Tuna? Safe Amounts, Mercury Risk, and Better Fish Choices"
slug: "can-cats-eat-tuna"
date: "2026-06-17"
category: "Nutrition & Safety"
featuredImage: "/api/og/blog/can-cats-eat-tuna"
subcategory: "Toxic Foods"
tags: ["can cats eat tuna", "is tuna safe for cats", "canned tuna for cats", "cats", "tuna", "mercury", "fish", "thiamine", "nutrition", "feline"]
excerpt: "Cats can eat a small amount of plain water-packed tuna as an occasional treat, but tuna should not be a staple food. Learn safe amounts, mercury risk, and better fish choices."
sources:
  ...
  - name: "Cornell Feline Health Center - Feeding Your Cat"
    ...
    type: "guideline"
seo:
  title: "Can Cats Eat Tuna? Safe Amounts, Mercury Risk & Better Fish Choices"
  description: "Cats can eat small amounts of plain water-packed tuna occasionally, but not daily. Learn safe serving sizes, mercury risk, thiamine deficiency, and safer fish options."
  ogImage: "https://www.getpetvitals.com/api/og/blog/can-cats-eat-tuna"
readNext:
  - "can-dogs-eat-onions"
...
Yes, cats can eat a small amount of plain tuna packed in water as an occasional treat. Tuna should not replace complete cat food, and it should not be fed daily because of mercury exposure, thiamine imbalance, salt, and nutritional gaps.

For most healthy adult cats, keep tuna to a teaspoon or small spoonful once a week or less. Avoid tuna in oil, brine, seasoned tuna, tuna salad, and tuna with onion or garlic ingredients.

## Why Tuna Is an Occasional Treat, Not a Meal
