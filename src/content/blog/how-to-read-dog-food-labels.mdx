...
sources:
  ...
  - name: "Tufts Clinical Nutrition Service — Pet Food Basics"
    ...
    type: "academic"
seo:
  title: "How to Read Dog Food Labels: AAFCO & Ingredients"
  description: "Decode dog food labels, AAFCO statements, guaranteed analysis, ingredient splitting, and marketing terms before choosing a food."
readNext:
