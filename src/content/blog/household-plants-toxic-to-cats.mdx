...
seo:
  ...
  ogImage: "https://www.getpetvitals.com/api/og/blog/household-plants-toxic-to-cats"
readNext:
  - "lily-toxicity-cats"
...
## Quick Answer: Which Houseplants Are Most Toxic to Cats?

The highest-risk houseplants for cats are true lilies, sago palm, dieffenbachia, pothos, philodendron, aloe, English ivy, peace lily, snake plant, and jade plant. True lilies and sago palm are the emergency-level plants on this list because they can cause kidney or liver failure.

If your cat chewed an unknown plant, photograph the plant, remove access, and search the exact name in the [cat toxicity guide](/toxicity/cats). For drooling, vomiting, tremors, collapse, trouble breathing, or any lily or sago palm exposure, use the [poisoning symptoms guide](/toxicity/symptoms) and call a veterinarian or pet poison hotline immediately.

## Cat Plant Safety Triage

<div className="overflow-x-auto mb-4">
  <table className="w-full border-collapse">
    <thead>
      <tr>
        <th className="border px-3 py-2 text-left font-semibold bg-muted">Risk level</th>
        <th className="border px-3 py-2 text-left font-semibold bg-muted">Examples</th>
        <th className="border px-3 py-2 text-left font-semibold bg-muted">What to do</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td className="border px-3 py-2">Emergency</td>
        <td className="border px-3 py-2">True lilies, sago palm, oleander, foxglove</td>
        <td className="border px-3 py-2">Call a vet or poison hotline now. Do not wait for symptoms.</td>
      </tr>
      <tr>
        <td className="border px-3 py-2">Painful mouth irritation</td>
        <td className="border px-3 py-2">Pothos, philodendron, dieffenbachia, peace lily</td>
        <td className="border px-3 py-2">Rinse the mouth if safe, watch breathing, and call a vet if swelling or distress appears.</td>
      </tr>
      <tr>
        <td className="border px-3 py-2">Digestive upset</td>
        <td className="border px-3 py-2">Snake plant, aloe, English ivy, jade plant</td>
        <td className="border px-3 py-2">Remove the plant, photograph it, and ask your vet whether monitoring or an exam is safer.</td>
      </tr>
    </tbody>
  </table>
</div>

For deeper emergency pages, see [lily toxicity in cats](/blog/lily-toxicity-cats), [sago palm toxicity in pets](/blog/sago-palm-toxicity-pets), and [emergency vet cost planning](/insurance/emergency-vet-cost).
