---
title: "Is Sago Palm Toxic to Dogs and Cats? Emergency Symptoms and Treatment"
...
tags: ["is sago palm toxic to dogs", "is sago palm toxic to cats", "sago palm poisoning", "sago palm", "cycasin", "liver failure", "toxic plants", "dogs", "cats", "garden danger", "emergency"]
excerpt: "Sago palm is highly toxic to dogs and cats. All parts are dangerous, especially seeds. Learn emergency symptoms, treatment steps, and why pet owners should remove this plant."
sources:
  ...
  - name: "Merck Veterinary Manual - Cycad Toxicosis"
    ...
    type: "guideline"
seo:
  title: "Is Sago Palm Toxic to Dogs & Cats? Emergency Symptoms & Treatment"
  description: "Yes. Sago palm is highly toxic to dogs and cats. Learn which parts are poisonous, early symptoms, emergency treatment, and why seeds are especially dangerous."
...
## Quick Answer: Is Sago Palm Toxic to Dogs and Cats?

Yes. Sago palm is highly toxic to both dogs and cats. Every part of the plant is dangerous, but the seeds are especially poisonous and can cause vomiting, liver failure, bleeding problems, seizures, and death.

If your pet chewed or swallowed any part of a sago palm, treat it as an emergency and contact a veterinarian or pet poison hotline immediately.

## Sago Palm Emergency Checklist

1. Move your pet away from the plant and collect any chewed leaves, roots, or seeds.
2. Take clear photos of the whole plant and the part your pet may have eaten.
3. Call your veterinarian, an emergency hospital, or a pet poison hotline before symptoms appear.
4. Do not induce vomiting unless a veterinary professional tells you to.
5. Bring the plant sample or photos to the clinic and ask about liver monitoring.

Use the direct [sago palm toxicity record](/toxicity/sago-palm) for a fast risk check. If signs are already present, compare them with the [poisoning symptoms guide](/toxicity/symptoms) and review possible [emergency vet costs](/insurance/emergency-vet-cost) before treatment decisions become urgent.
...
<div className="overflow-x-auto mb-4">
  <table className="w-full border-collapse">
    <thead>
      <tr>
        <th className="border px-3 py-2 text-left font-semibold bg-muted">Plant part</th>
        <th className="border px-3 py-2 text-left font-semibold bg-muted">Cycasin concentration</th>
        <th className="border px-3 py-2 text-left font-semibold bg-muted">Risk level</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td className="border px-3 py-2">Seeds / nuts</td>
        <td className="border px-3 py-2">Very high, about 2-4% cycasin</td>
        <td className="border px-3 py-2">Extremely dangerous; 1-2 seeds can be fatal for a medium dog</td>
      </tr>
      <tr>
        <td className="border px-3 py-2">Young leaves</td>
        <td className="border px-3 py-2">High</td>
        <td className="border px-3 py-2">Dangerous</td>
      </tr>
      <tr>
        <td className="border px-3 py-2">Mature leaves</td>
        <td className="border px-3 py-2">Moderate</td>
        <td className="border px-3 py-2">Dangerous if chewed repeatedly</td>
      </tr>
      <tr>
        <td className="border px-3 py-2">Roots / stem</td>
        <td className="border px-3 py-2">Moderate to high</td>
        <td className="border px-3 py-2">Dangerous; often excavated and chewed by dogs</td>
      </tr>
      <tr>
        <td className="border px-3 py-2">Processed sago food starch</td>
        <td className="border px-3 py-2">None when properly processed</td>
        <td className="border px-3 py-2">Different from the plant; do not use food starch safety to judge a live sago palm</td>
      </tr>
    </tbody>
  </table>
</div>
